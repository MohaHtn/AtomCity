...
class ScorefetcherRepository(
    ...
    fun getScorefetcherPaginatedData(page: Int): Flow<ScorefetcherPlaysResponse?> = flow {
    ...
    fun getScorefetcherPlayerDetails(): Flow<ScorefetcherPlayerDetailsResponse?> = flow {
    ...
    fun getPlayById(id: Int, keyHash: String): Flow<ScorefetcherApiData?> = flow {
        try {
