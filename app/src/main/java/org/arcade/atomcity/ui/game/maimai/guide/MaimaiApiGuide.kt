...
const val MAIMAI_API_GUIDE_TEXT = "Pour obtenir votre clé API, rendez-vous sur maitea.app et connectez-vous. Si vous n'avez pas de compte, n'hésitez pas à vous en créer un ! Un fois connecté, allez sur 'Profile' dans le menu déroulant."
...
@Composable
fun MaimaiApiGuide(visible: MutableState<Boolean>, onDismiss: () -> Unit, apiKeyManager: ApiKeyManager) {
