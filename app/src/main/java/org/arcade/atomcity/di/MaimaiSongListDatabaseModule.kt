...
val  maimaiSongListDatabaseModule = module {
    single { Moshi.Builder().build() }
    single(named("maimaiSongListDatabaseModule")) { provideMaimaiSongListDatabase(androidContext()) }
}
...
private fun provideMaimaiSongListDatabase(context: Context): AppDatabase {
